...
public class PCA {
    ...
    volatile static int dépôt = 0; //VOLATILEUH
    volatile static int retrait = 0;//VOLATILEUH
...
// dépose des suites de N entiers identiques, en incrémentant la valeur déposée à chaque nouvelle suite
    public void run() {
        for (;;) {
            ...
            while (PCA.dépôt-PCA.retrait==PCA.N) {/*System.out.println("producteur attend");*/}
...
class Consommateur implements Runnable {
    public void run() {
        ...
        for (;;) {
            ...
            while (PCA.dépôt==PCA.retrait) {/*System.out.println("consommateur attend");*/}
